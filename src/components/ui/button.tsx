...
const buttonVariants = cva(
  ...
  focus-visible:ring-neutral-50 disabled:cursor-not-allowed disabled:opacity-60 md:h-12`,
  {
    variants: {
      variant: {
        default: 'bg-[#E12727] not-disabled:hover:bg-primary/90',
        secondary: 'bg-neutral-900 hover:bg-neutral-900/90',
